...
public class GstTaxLineService extends AccountManagementServiceAccountImpl {

  private TaxService taxService;

  @Inject
  public GstTaxLineService(FiscalPositionService fiscalPositionService, TaxService taxService) {
